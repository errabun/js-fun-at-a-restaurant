...
// no stockCount variable declared in code before, so I just assigned stockCount to inStock for this example
...
var vegetables = ["broccoli", "brussel sprouts", "carrots", "spinach", "kale"];
...
var fruits = ["apples", "oranges", "strawberries", "blueberries", "mango", "papaya", "raspberries"];
...
var groceryStore = {
  name: "Trader Joes",
  isOpen: true,
  departments: ["deli", "produce", "bakery", "alcohol"],
}
